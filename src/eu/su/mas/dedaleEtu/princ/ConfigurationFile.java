...
public final class ConfigurationFile {
	 ...
	 */
	public static String INSTANCE_TOPOLOGY="resources/ourmap-topology";
	//public static String INSTANCE_TOPOLOGY=null;
	
	/**
	 * Not null when the environment is loaded; should be null if the environment is generated or already online
	 */
	public static String INSTANCE_CONFIGURATION_ELEMENTS="resources/ourmap-elements";
	...
	public static String INSTANCE_CONFIGURATION_ENTITIES="resources/ourmap-entities";
