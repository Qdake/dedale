...
public class MapRepresentation implements Serializable {
	...
	/**
	 * Methode exporter la connaissance
	 */
	// exporter de la connaissance
	public String expo() {     //void --> String
		String aretes = "";
        try{
        	for (Edge e:this.g.getEdgeSet()) {           
	            Node n0 = e.getNode0();         
	            Node n1 = e.getNode1();               //e={n0,n1}
	            aretes = aretes +"*" + n0.getId() +"-"+ n1.getId();    //    n0-n1
        	}
        }catch(Exception ex) {};
		return aretes;
	}
